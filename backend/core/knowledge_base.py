...
# backend/core/knowledge_base.py（在 5.4 基础上追加，本节只展示新增内容）
# BGEMEmbedder / DocumentChunk 已在 5.4 定义，保持不变
...
# backend/core/knowledge_base.py（追加到 KnowledgeBaseClient，接 5.5 写入方法之后）
...
if __name__ == "__main__":
    bge_model=BGEMEmbedder(model_path="/Volumes/XD20/py_project/EduAgent/models/embedding/bge-m3")
    #测试加载模型
    print(bge_model)
